...
function part1() {
  ...
  inputArr.forEach(direction => {
    ...
    console.log(`starting direction: ${currDirection}`)
    if (direction.charAt(0) == 'F') {
      ...
      console.log(direction.charAt(0))
      ...
      console.log(`index pre mod: ${currIndex}`)
      currIndex = currIndex % directions.length;
      console.log(`index after mod: ${currIndex}`)
      currDirection = directions[currIndex];
      console.log(`newDir: ${currDirection}`);
    ...
    console.log(`ending position: ${startX}, ${startY}`)
    console.log(`ending direction: ${currDirection}`)
  });

  console.log(`end position: ${startX}, ${startY}`)
  console.log(`end direction: ${currDirection}`);
  console.log(Math.abs(startX) + Math.abs(startY))
}
...
function part2() {
  ...
  inputArr.forEach(direction => {
    console.log(`direction: ${direction}`)
    console.log(`starting position: ${startX}, ${startY}`)
    console.log(`starting waypoint: ${waypointX}, ${waypointY}`)
    if (direction.charAt(0) == 'F') {
      let amount = parseInt(direction.slice(1));
    ...
    console.log(`ending waypoint: ${waypointX}, ${waypointY}`)
  });
