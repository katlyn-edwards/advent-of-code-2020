let input = `light chartreuse bags contain 1 mirrored yellow bag, 2 vibrant violet bags.
...
function getAllOptions2(startingColor, ruleMap, multiplier) {
  console.log(`startingColor: ${startingColor}`)
   ...
   for (let i = 0; i < possibilities.length; i++ ) {
    ...
    console.log(`current bag count: ${possible.count}`);
    console.log(`current multiplier: ${multiplier}`);
    console.log((possible.count * multiplier) + recursedAnswer);
