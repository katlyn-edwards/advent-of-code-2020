...
function getYourSpecificSeatIdOld() {
  // LOL THIS IS NOT HOW THE QUESTION WORKS
  // GIVING UP AND STARTING OVER BELOW.
  let plane = [];
  input.forEach((str) => {
    const [row, seat] = getRowAndSeat(str);
    console.log(`row: ${row}`);
  ...
  const yourSeatId = getSeatId(emptyRow, emptySeat);
  console.log(`your seat id: ${yourSeatId}`)
}

function getYourSpecificSeatID() {
